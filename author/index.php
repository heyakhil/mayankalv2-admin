...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <?php   
          $sql="SELECT * FROM `auther_coins_earn` WHERE `author_uid`='$auth'";
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-bitcoin fa-3x"></i>
            <div class="info">
              <h4>Total Coins</h4>
              <p><b>
                <?php if ($result['coin_earn']){echo $result['coin_earn'];}else{echo "0";} ?>
              </b></p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-rupee fa-3x"></i>
            <div class="info">
              <h4>Earning</h4>
              <p><b><?php  echo $result['coin_earn']/100; ?></b></p>
            </div>
          </div>
        </div>
        <!-- end -->
            ...
            <ul class="dashboard-box-list">
								<li>
									...
									<span class="notification-text">
										   You have a new <strong> order</strong> 
									</span>
