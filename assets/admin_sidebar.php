      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Users</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" id="users" href="bootstrap-components.html"><i class="icon fa fa-circle-o"></i> User Reported</a></li>
            <li><a class="treeview-item" id="emtou" href="https://fontawesome.com/v4.7.0/icons/" target="_blank" rel="noopener"><i class="icon fa fa-circle-o"></i> Email To User</a></li>
            <li><a class="treeview-item" id="feed" href="ui-cards.html"><i class="icon fa fa-circle-o"></i> FeedBack</a></li>
            <li><a class="treeview-item" id="weinf" href="ui-cards.html"><i class="icon fa fa-circle-o"></i> Web Info</a></li>
            <li><a class="treeview-item" id="sendn" href="widgets.html"><i class="icon fa fa-circle-o"></i>Send Notification</a></li>
          </ul>
        </li>
        ...
        <li class="treeview" id="expand"><a class="app-menu__item" id="author" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Authors</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" id="order" href="form-components.html"><i class="icon fa fa-circle-o"></i> Orders</a></li>
            <li><a class="treeview-item" id="complete" href="form-custom.html"><i class="icon fa fa-circle-o"></i> Completed</a></li>
            <li><a class="treeview-item" id="sendem" href="form-notifications.html"><i class="icon fa fa-circle-o"></i> Send Email</a></li>
          </ul>
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Admin</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" id="createadmin" href="table-basic.html"><i class="icon fa fa-circle-o"></i> Create Admin</a></li>
            <li><a class="treeview-item" id="earning" href="table-data-table.html"><i class="icon fa fa-circle-o"></i>Our Earning</a></li>
          </ul>
        </li>
      </ul>
    </aside>
