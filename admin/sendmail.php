<?php    
    ...
    if(!isset($_GET['email'])){
        header("location:email_to_user.php");
    }
?>
<?php
    if(isset($_POST['submit'])){
      ...
      $body=$_POST['body'];
        ...
        <script>
                ...
                window.open("email_to_user.php", "_self");
        </script>
    <?php 
    }
    else{
        ...
        <script>
                ...
                window.open("sendmail.php?email=<?php echo $email; ?>&name=<?php echo $name; ?>", "_self");
        </script>
    <?php 
...
<body>
    <div class="container">
                <form class="form-group" method="post" action="sendmail.php?email=<?php echo $_GET['email']; ?>">
